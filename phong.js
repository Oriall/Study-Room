function pic1() {
    ...
    document.getElementById('phong9').style.display = "none";
...
function updateList() {
    ...
    document.getElementById("list5").style.display = currentList === 5 ? "flex" : "none";
}

function next() {
    currentList = currentList === 5 ? 1 : currentList + 1;
    updateList();
}

function prev() {
    currentList = currentList === 1 ? 5 : currentList - 1;
    updateList();
}
